...
from bingo.evolutionary_algorithms.mu_plus_lambda_simplified import MuPlusLambdaSimplified
...
def execute_generational_steps():
  ...
  ea = MuPlusLambdaSimplified(evaluator, crossover, mutation, 0.4, 0.4, number_offspring = POP_SIZE, simplified_population_size=SIMPLIFIED_POP_SIZE, tournament_selection_size=TOURNAMENT_SIZE)  
...
def main():
  print("Executing simplification test with:\n  STACK_SIZE =", STACK_SIZE, "\n  TOURNAMENT_SIZE =", TOURNAMENT_SIZE, "\n  POP_SIZE =", POP_SIZE, "\n  SIMPLIFIED_POP_SIZE =", SIMPLIFIED_POP_SIZE, "\n  MIN_GENERATIONS =", MIN_GENERATIONS, "\n  MAX_GENERATIONS =", MAX_GENERATIONS, "\n  FITNESS_THRESHOLD =", FITNESS_THRESHOLD, "\n  PATH =", PATH)
